...
class handDetector:
  def __init__(self,mode=False,maxHands=2,detectionConfi=0.5,trackingConfi=0.5):
    self.mode=mode
    ...
    self.hands=self.mpHands.Hands(self.mode,self.maxHands,self.detectionConfi,self.trackingConfi)
